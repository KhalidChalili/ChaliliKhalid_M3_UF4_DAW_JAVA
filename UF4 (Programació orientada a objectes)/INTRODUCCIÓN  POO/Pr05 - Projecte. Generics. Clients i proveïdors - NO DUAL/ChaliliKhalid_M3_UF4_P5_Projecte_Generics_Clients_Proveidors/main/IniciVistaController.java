				...
				do {
					...
					case 3:
						...
						if (prodModificar == null) {
							...
							System.out.println(prodModificar);
				...
				do {
					...
					case 2:
						...
						if (clientBuscar == null) {
							...
							System.out.println(clientBuscar);
						}
						break;
				...
				do {
					...
					case 2:
						...
						if (ProveidorBuscar == null) {
							...
							System.out.println(ProveidorBuscar);
						}
						break;
